...
_FLEURS_LANG_SHORT_TO_LONG_2 = _FLEURS_LANG_SHORT_TO_LONG
...
_FLEURS_GROUP_TO_LONG = OrderedDict({
    "western_europe": ["Asturian", "Bosnian", "Catalan", "Croatian", "Danish", "Dutch", "English", "Finnish", "French", "Galician", "German", "Greek", "Hungarian", "Icelandic", "Irish", "Italian", "Kabuverdianu", "Luxembourgish", "Maltese", "Norwegian", "Occitan", "Portuguese", "Spanish", "Swedish", "Welsh"],
    "eastern_europe": ["Armenian", "Belarusian", "Bulgarian", "Czech", "Estonian", "Georgian", "Latvian", "Lithuanian", "Macedonian", "Polish", "Romanian", "Russian", "Serbian", "Slovak", "Slovenian", "Ukrainian"],
    "central_asia_middle_east_north_africa": ["Arabic", "Azerbaijani", "Hebrew", "Kazakh", "Kyrgyz", "Mongolian", "Pashto", "Persian", "Sorani-Kurdish", "Tajik", "Turkish", "Uzbek"],
...
FLEURS_GROUP_INFO = {
    group: {
        "configs": configs,
        "lang_ids": [_FLEURS_LANG_TO_GID[c] for c in configs],
        "names": names,
    }
    for group, names in _FLEURS_GROUP_TO_LONG.items()
    for configs in [[_FLEURS_LONG_TO_LANG[name] for name in names]]
}
